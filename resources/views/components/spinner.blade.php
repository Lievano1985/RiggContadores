{{-- <div
    wire:loading
    wire:target="{{ $target }}"
    class="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/50 h-screen w-screen"
>
    <svg
        class="animate-spin h-12 w-12 text-amber-500 mb-3"
...
<div class="flex h-screen items-center justify-center space-y-2">
    ...
    <p class="text-white dark:text-gray-200 text-sm">Procesando Petición...</p>
</div>
</div>
