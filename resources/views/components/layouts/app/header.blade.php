...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="app-shell-body min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="app-shell-header border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:sidebar stashable sticky class="app-shell-sidebar lg:hidden border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
